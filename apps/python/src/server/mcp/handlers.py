...
Wired to real agent execution via ``server.agent.execute_agent_run``
and dynamic tool listing via ``server.agent.get_agent_tool_info``.
"""
...
class McpMethodHandler:
    ...
    async def _execute_agent(
        ...
        Delegates to ``server.agent.execute_agent_run`` for real
        agent execution.
        ...
        from server.agent import execute_agent_run
